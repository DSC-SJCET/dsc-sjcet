    ...
    <div class="row flex-column-reverse flex-sm-row flex-lg-row">
      <div class="col-md-4 col-12">
        <div class="footer-widget first-of-footer-widget">
          <img src="https://res.cloudinary.com/dscsjcet-cdn/image/upload/v1599593780/logo1_fsklb7.png" class="logo-sm mb-10" alt="{{ config('app.name') }}">
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            <div class="footer-widget">
              ...
              <ul class="list-unstyled">
                <li>
                  <a href="mailto: developerstudentclubsjcet@gmail.com" target="_blank" rel="noreferrer">File a bug</a>
                </li>
                <li>
                  <a href="https://github.com/DSCSJCET/dsc-sjcet" target="_blank" rel="noreferrer">View source</a>
                </li>
                <li>
