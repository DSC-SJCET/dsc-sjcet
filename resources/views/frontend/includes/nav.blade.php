<nav class="navbar navbar-expand-lg fixed-top custom-menu custom-menu__light">
  <div class="container">
    <a class="navbar-brand" href="{{ route('index') }}">
      <img src="https://res.cloudinary.com/dscsjcet-cdn/image/upload/v1599593776/dsc-logo_y0rdxx.png" class="logo-sm" alt="{{ config('app.nick') }}">
    </a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      @else
        ...
        <div class="custom-menu__right">
        <a href="{{ config('app.info.memberformlink') }}" class="event-btn" ><i class="fa fa-users"></i> View Our Chapter</a>
      <!--    @auth
